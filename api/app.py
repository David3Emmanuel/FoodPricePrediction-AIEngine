...
COMMODITY_MAPPING = {
    ...
    # Standardized NBS mappings (all 29 items from data_frequency_audit.csv)
    "beans-brown": {
        "Food_Item": "beans",
        "Item_Type": "brown",
        "Category": "1000 g",
